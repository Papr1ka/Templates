...
|:-------------------:|:--------------------------------:|
|<!--Номер варианта-->|<!--Уникальное задание варианта-->|
...
"}
```
### Размер записи файла в байтах - <!--Сколько байт занимает структура-->
### Прототипы операций по управлению двоичным файлом с указанием предусловия и постусловия
1. Предусловие -- пример<br>
<!--параметры функции(в этой строке почему-то выравнивание по ширине)-->
Постусловие -- <!--возвращаемое значение-->
<!--заголовок функции-->
...
|:--------------------------------:|:--------------------------:|
|<!--Название поля в хэш таблице-->|<!--Назначение этого поля-->|  <!--Одна строка таблицы, копировать сколько нужно строк-->
